...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen font-sans bg-natural-50 text-natural-900 overflow-x-hidden selection:bg-brand-blue-100 selection:text-brand-blue-900" id="otica-root">
      ...
      <div className="bg-brand-blue-950 text-white text-xs py-2 px-4 border-b border-brand-blue-800 text-center relative z-40 font-medium" id="top-bar">
        <div className="max-w-7xl mx-auto flex justify-center items-center gap-6">
          ...
          <span className="hidden md:inline-flex items-center gap-1.5">
            <Clock className="w-3.5 h-3.5 text-brand-yellow-400" />
      ...
      {/* FLOATING HEADER */}
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-brand-blue-100/60 shadow-xs transition-all" id="main-header">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          
          {/* BRAND LOGO */}
          <a href="#otica-root" className="flex items-center gap-2.5 group" id="brand-logo">
            <div className="relative flex items-center justify-center w-11 h-11 rounded-xl shadow-md overflow-hidden bg-white border border-brand-blue-100">
              <img 
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_RikKwYiJbhg12av5QJ8iY-TWlnLAvWS3TQ&s" 
            ...
            <div>
              <span className="text-xl font-serif font-bold text-brand-blue-950 tracking-tight block">
                Óticas <span className="text-brand-yellow-600 font-sans font-extrabold uppercase text-[15px] tracking-widest block sm:inline sm:text-lg sm:capitalize sm:font-serif leading-none">Acaz</span>
              </span>
          ...
          {/* DESKTOP NAV */}
          <nav className="hidden lg:flex items-center gap-8 text-sm font-semibold tracking-wide text-brand-blue-950/80">
            <a href="#produtos-exclusivos" className="hover:text-brand-blue-600 transition-colors">Nossa Loja</a>
            <a href="#cuidados-clinicos" className="hover:text-brand-blue-600 transition-colors">Exames de Vista</a>
            <a href="#sobre-nos" className="hover:text-brand-blue-600 transition-colors">Por Que Nós?</a>
            <a href="#depoimentos" className="hover:text-brand-blue-600 transition-colors">Opiniões</a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            <a 
              href="tel:1141257371" 
              className="hidden sm:inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-brand-blue-600 transition-colors px-3 py-2"
              id="header-phone-accent"
            >
              <Phone className="w-4 h-4 text-brand-yellow-500" />
              (11) 4125-7371
            </a>
            ...
            >
              <Calendar className="w-4 h-4 text-brand-yellow-400 sm:w-4.5 sm:h-4.5" />
              Agendar Exame
            </a>
          </div>
        </div>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center py-16 lg:py-24 overflow-hidden" id="hero-premium">
        ...
        <div className="absolute bottom-10 right-10 w-[350px] h-[350px] bg-white rounded-full blur-2xl -z-10 pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left relative z-10" id="hero-text-container">
              ...
              {/* BRAND EMBLEM TAG */}
              <div 
                className="inline-flex items-center gap-2 bg-brand-yellow-150 border border-brand-yellow-250 text-brand-yellow-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6"
                id="hero-tag"
              >
                <Sparkle className="w-3.5 h-3.5 text-brand-yellow-500 fill-brand-yellow-500 animate-spin-slow" />
                Um Novo Olhar Para o Seu Bem-Estar e Estilo
              </div>

              {/* HEADING (EMOTIONAL & FORMIDABLE) */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-semibold tracking-tight text-brand-blue-950 leading-[1.1] mb-6">
                A vida é feita de detalhes. <span className="text-brand-blue-600 block italic font-medium font-serif mt-1">Enxergue-os com afeto e elegância.</span>
              </h1>

              {/* SUBHEADLINE (WARM, HUMAN & EMOTIONAL) */}
              <p className="text-gray-600 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
                ...
                >
                  ...
                  <ChevronRight className="w-5 h-5 text-brand-yellow-400 group-hover:translate-x-1 transition-transform" />
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-white hover:bg-neutral-50 text-emerald-700 font-semibold text-center py-4 px-8 rounded-xl border-2 border-emerald-600/70 shadow-sm transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-8 mt-12 pt-8 border-t border-brand-blue-100 w-full" id="hero-bullet-trust">
                <div>
                  <span className="text-2xl sm:text-3xl font-bold text-brand-blue-950 block">100%</span>
                  <span className="text-xs sm:text-sm text-gray-500">Exatidão de Grau</span>
                </div>
                <div>
                  <span className="text-2xl sm:text-3xl font-bold text-brand-blue-950 block">+5 mil</span>
                  <span className="text-xs sm:text-sm text-gray-500">Olhares Cuidando</span>
                </div>
                <div>
                  <span className="text-2xl sm:text-3xl font-bold text-brand-blue-950 block">40 min</span>
                  <span className="text-xs sm:text-sm text-gray-500">Montagem Expressa</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 relative" id="hero-image-column">
              <div className="relative mx-auto max-w-[380px] lg:max-w-none">
                ...
                <div className="absolute -top-4 -left-4 bg-white/95 backdrop-blur-xs p-3 rounded-2xl shadow-lg border border-brand-blue-100 flex items-center gap-2.5 z-20 animate-bounce-slow">
                  <div className="w-10 h-10 rounded-xl bg-amber-500/10 text-amber-600 flex items-center justify-center">
                    <Award className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="font-extrabold text-brand-blue-950 text-sm block">Premium Care</span>
                    <span className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Showroom Exclusivo</span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-6 -right-4 bg-brand-blue-950 text-white p-4 rounded-2xl shadow-xl flex items-center gap-3 z-20">
                  ...
                  <div>
                    <span className="text-xs text-brand-yellow-400 block font-mono">Suporte Imediato</span>
      ...
      <section className="bg-white py-16 sm:py-24 border-y border-neutral-100" id="sobre-nos">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-brand-blue-600 font-mono text-xs uppercase tracking-widest font-bold block mb-2">História e Compromisso</span>
            <h2 className="text-3xl sm:text-4xl font-serif font-semibold text-brand-blue-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div 
                  key={idx} 
                  className="bg-neutral-50 rounded-2xl p-6 sm:p-8 border border-neutral-150 transition-all hover:-translate-y-1.5 hover:shadow-lg hover:border-brand-blue-100 text-left flex flex-col justify-between"
                  id={`pillar-card-${idx}`}
                >
                  <div>
                    <div className="w-12 h-12 rounded-xl bg-brand-blue-50 text-brand-blue-600 flex items-center justify-center mb-6 border border-brand-blue-100">
                      <IconComp className="w-6 h-6" />
                    </div>
                    <span className="text-[10px] font-mono font-bold text-brand-yellow-600 uppercase tracking-widest block mb-2">
                      {pillar.badge}
                    </span>
                    <h3 className="text-lg font-bold text-brand-blue-950 mb-3">{pillar.title}</h3>
                    <p className="text-gray-500 text-sm leading-relaxed">{pillar.desc}</p>
                  </div>
                  <div className="mt-6 pt-4 border-t border-neutral-200/50 flex items-center text-brand-blue-600 text-xs font-semibold gap-1">
                    Saúde em Primeiro Lugar <CheckCircle className="w-3.5 h-3.5 text-brand-yellow-500" />
                  </div>
                </div>
              );
            })}
      ...
      <section className="bg-white py-16 sm:py-24 border-y border-neutral-100/80 overflow-hidden" id="cuidados-clinicos">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative order-last lg:order-first" id="clinic-image-side">
              ...
              <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-xs p-4 rounded-xl shadow-lg border border-neutral-100 flex items-center gap-3 z-10 max-w-xs">
                <div className="w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center shrink-0">
                  <Check className="w-5 h-5 stroke-[3]" />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-brand-blue-950 block">Higienização Total</h4>
                  <p className="text-[11px] text-gray-500">Aparelhos monitorados e sanitizados entre exames.</p>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 text-left flex flex-col justify-center items-start" id="clinic-content-side">
              <div className="bg-brand-blue-50 text-brand-blue-700 text-xs font-bold font-mono px-3.5 py-1.5 rounded-full mb-4">
                Consultório Optométrico Licenciado
              </div>
              
              <h2 className="text-3xl sm:text-4xl font-serif font-semibold text-brand-blue-950 mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8 w-full" id="grid-clinic-perks">
                <div className="flex gap-3">
                  <div className="w-5 h-5 rounded-full bg-brand-yellow-100 text-brand-yellow-700 flex items-center justify-center shrink-0 mt-0.5">
                    <Check className="w-3.5 h-3.5 stroke-[3]" />
                  </div>
                  <div>
                    <h4 className="text-sm font-semibold text-brand-blue-950">Aparelhos Digitais</h4>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-brand-blue-950">Optometristas Credenciados</h4>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-brand-blue-950">Montagem Express</h4>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-brand-blue-950">Retorno de Adaptação</h4>
      ...
      <section className="bg-natural-100 py-20 sm:py-28 text-left border-b border-neutral-200" id="produtos-exclusivos">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start relative z-10">
              <span className="text-brand-blue-600 font-bold font-mono text-xs uppercase tracking-widest block mb-2">
                Experimentação Presencial
              </span>
              <h2 className="text-3xl sm:text-4xl font-serif text-brand-blue-950 font-semibold mb-6 leading-tight">
                Por que escolher seus óculos pessoalmente faz toda a diferença?
              </h2>
              <p className="text-gray-650 text-sm sm:text-base leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full mb-8">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-brand-blue-950">Ajuste Anatômico Sob Medida</h4>
                ...
                <div className="flex gap-3">
                  <div className="w-10 h-10 rounded-xl bg-brand-yellow-100 text-brand-yellow-700 flex items-center justify-center shrink-0">
                    <Sparkles className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="font-bold text-sm text-brand-blue-950">Curadoria e Textura Real</h4>
                    <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-brand-blue-950">Consultoria Estética Express</h4>
                    <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-sm text-brand-blue-950">Centragem Pupilográfica</h4>
                    <p className="text-xs text-gray-500 mt-1 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
                ...
                >
                  ...
                  <ChevronRight className="w-4 h-4 text-brand-yellow-400 group-hover:translate-x-1 transition-transform" />
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-white hover:bg-neutral-50 text-brand-blue-950 font-semibold text-center text-sm py-4 px-8 rounded-xl border border-gray-200 shadow-sm transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
                >
            ...
            <div className="lg:col-span-5 relative mt-6 lg:mt-0">
              <div className="relative mx-auto max-w-[420px] lg:max-w-none">
                ...
                <div className="absolute -top-5 -right-5 bg-white p-4 rounded-2xl shadow-xl border border-brand-blue-150 flex flex-col items-start gap-1 z-20 max-w-[200px]">
                  <span className="text-[10px] text-brand-blue-600 font-bold uppercase tracking-wider block">Cafezinho Gourmet</span>
                ...
                <div className="bg-white rounded-[2.5rem] border border-gray-150 p-6 shadow-xl relative overflow-hidden flex flex-col">
                  <div className="relative aspect-[4/3] rounded-[1.8rem] overflow-hidden bg-brand-blue-900 border border-neutral-100">
                    <img
                  ...
                  <div className="mt-6 text-left">
                    <h3 className="font-serif font-semibold text-lg text-brand-blue-950 mb-2">
                    ...
                    <div className="bg-brand-blue-50/50 rounded-2xl p-4 border border-brand-blue-100/60 flex items-start gap-3">
                      <Clock className="w-5 h-5 text-brand-blue-600 shrink-0 mt-0.5" />
                      <div>
                        <span className="block text-xs font-bold text-brand-blue-950 uppercase tracking-wide">Experimentação Sem Fila</span>
                        <span className="block text-xs text-gray-500 mt-0.5">Agendando previamente, você tem um consultor exclusivo e horário reservado.</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-brand-blue-950 text-white rounded-3xl p-8 sm:p-12 mt-16 relative overflow-hidden border border-brand-blue-800 shadow-xl" id="editorial-luxury-banner">
            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-yellow-500/10 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
              <div className="lg:col-span-7 text-left">
                <span className="text-brand-yellow-400 text-xs font-mono font-bold uppercase tracking-widest block mb-2">Sua visão com os melhores</span>
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-semibold tracking-tight text-brand-blue-50">
                ...
                <div className="flex flex-wrap gap-4 mt-6">
                  <span className="bg-white/10 text-white text-xs px-3 py-1.5 rounded-lg border border-white/10 font-medium">Antirreflexo Inteligente</span>
                  <span className="bg-white/10 text-white text-xs px-3 py-1.5 rounded-lg border border-white/10 font-medium font-serif italic">100% Polarizadas</span>
                  <span className="bg-white/10 text-white text-xs px-3 py-1.5 rounded-lg border border-white/10 font-medium">Filtro de Luz Azul Real</span>
                </div>
              </div>
      ...
      <section className="bg-white py-16 sm:py-24 border-y border-neutral-100" id="servicos-premium">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-brand-blue-600 font-bold font-mono text-xs uppercase tracking-widest block mb-2">Excelência Clínica e Comercial</span>
            <h2 className="text-3xl sm:text-4xl font-serif text-brand-blue-950 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="services-cards-grid">
            {servicesData.map((service, index) => {
              ...
              return (
                <div 
                  key={service.id} 
                  className="bg-natural-100/50 rounded-2xl p-6 border border-neutral-200/60 text-left hover:border-brand-blue-200 transition-colors flex flex-col justify-between"
                  id={`service-card-${index}`}
                >
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-brand-blue-50 text-brand-blue-600 flex items-center justify-center mb-5">
                      <ServiceIcon className="w-5 h-5" />
                    </div>
                    <h3 className="font-bold text-brand-blue-950 text-base mb-2">{service.title}</h3>
                  ...
                  <div className="mt-4 pt-3 border-t border-neutral-250/50">
                    <span className="text-[10px] text-brand-yellow-600 font-bold uppercase block tracking-wider">Benefício Primário:</span>
                    <span className="text-xs font-semibold text-brand-blue-950 mt-0.5 block">{service.benefit}</span>
                  </div>
                </div>
              );
            })}
      ...
      <section className="bg-natural-100/60 py-20 sm:py-28 text-natural-900 relative overflow-hidden text-left border-b border-neutral-200" id="depoimentos">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-4" id="testimonials-context">
              <span className="text-brand-blue-700 font-bold font-mono text-xs uppercase tracking-widest block mb-2">Comunidade e Depoimentos</span>
              <h2 className="text-3xl sm:text-4xl font-serif font-semibold text-brand-blue-950 leading-tight">
              ...
              <p className="text-gray-650 text-sm mt-5 leading-relaxed">
              ...
              <div className="mt-8 p-4 bg-brand-blue-50/80 rounded-2xl border border-brand-blue-150 inline-flex items-center gap-3 shadow-xs">
                <div className="flex -space-x-2">
                  <div className="w-8 h-8 rounded-full bg-indigo-200 border-2 border-white flex items-center justify-center text-xs font-extrabold text-brand-blue-950">M</div>
                  <div className="w-8 h-8 rounded-full bg-green-200 border-2 border-white flex items-center justify-center text-xs font-extrabold text-brand-blue-950">J</div>
                  <div className="w-8 h-8 rounded-full bg-amber-200 border-2 border-white flex items-center justify-center text-xs font-extrabold text-brand-blue-950">R</div>
                </div>
                <div className="text-xs text-brand-blue-950">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="testimonials-grid">
              {testimonialsData.map((testimonial) => (
                <div 
                  key={testimonial.id} 
                  className="bg-white text-natural-900 p-6 rounded-3xl border border-brand-blue-100/50 shadow-sm hover:shadow-md transition-all duration-300 relative flex flex-col justify-between hover:border-brand-blue-200"
                  id={`testimonial-card-${testimonial.id}`}
                >
                  <div>
                    {/* Stars bar */}
                    <div className="flex gap-1 mb-4 text-brand-yellow-500">
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                    <div className="w-9 h-9 rounded-full bg-brand-blue-50 text-brand-blue-700 font-bold text-sm shrink-0 flex items-center justify-center border border-brand-blue-100">
                      {testimonial.name[0]}
                    </div>
                    <div>
                      <h4 className="font-bold text-brand-blue-950 text-xs sm:text-sm leading-tight">{testimonial.name}</h4>
      ...
      <section className="bg-natural-50 py-20 sm:py-24 border-b border-neutral-200" id="agendamento-direto">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          
          <div className="bg-white rounded-[2.5rem] p-6 sm:p-12 border border-brand-blue-100 shadow-xl relative overflow-hidden" id="form-booking-box">
            ...
            <div className="text-center max-w-2xl mx-auto mb-8 relative z-10">
              <span className="bg-brand-yellow-105 border border-brand-yellow-300 text-brand-yellow-700 text-[10px] font-bold uppercase tracking-wider px-3.5 py-1 rounded-full">
                Sua saúde em 1 clique
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-brand-blue-950 font-semibold mt-3">
            ...
            {bookingStep === 0 && (
              <form onSubmit={() => setBookingStep(1)} className="space-y-4 max-w-lg mx-auto relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-gray-500 mb-1 uppercase tracking-wide">Seu nome Completo</label>
                    <input
                      type="text"
                      required
                      ...
                      className="w-full bg-neutral-100 rounded-xl px-4 py-3 text-sm border border-neutral-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-blue-600/20 text-brand-blue-950 font-medium"
                      id="input-booking-name"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-500 mb-1 uppercase tracking-wide">WhatsApp com DDD</label>
                    <input
                      type="tel"
                      required
            ...
            {bookingStep === 1 && (
              <form onSubmit={handleBookingSubmit} className="space-y-5 max-w-lg mx-auto relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold text-gray-500 mb-1 uppercase tracking-wide">Preferência de Data</label>
                    <input
                      type="date"
                      required
                      value={bookingDate}
                      onChange={(e) => setBookingDate(e.target.value)}
                      className="w-full bg-neutral-100 rounded-xl px-4 py-3 text-sm border border-neutral-200 focus:bg-white focus:outline-none text-brand-blue-950 font-medium cursor-pointer"
                      id="input-booking-date"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-500 mb-1 uppercase tracking-wide">Melhor Período</label>
                    <select
                      value={bookingPeriod}
                ...
                <div className="flex gap-3 justify-center">
                  <button
                    ...
                    className="bg-neutral-100 text-gray-500 hover:bg-gray-200 text-sm font-semibold py-3.5 px-6 rounded-xl transition-colors cursor-pointer"
                    id="btn-back-step"
                  >
                    Voltar
                  </button>
            ...
            {bookingStep === 2 && (
              <div className="text-center py-6 relative z-10 max-w-lg mx-auto" id="booking-success-box">
                ...
                <h3 className="text-xl font-bold text-brand-blue-950 mb-2">Sua solicitação foi enviada!</h3>
                ...
                <button
                  ...
                  className="text-brand-blue-600 hover:text-brand-blue-800 text-xs font-semibold underline cursor-pointer"
      ...
      <footer className="bg-brand-blue-950 text-white pt-16 pb-8 border-t border-brand-blue-800 text-left relative z-10" id="rodape-profissional">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg overflow-hidden bg-white flex items-center justify-center border border-brand-blue-900">
                  <img 
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_RikKwYiJbhg12av5QJ8iY-TWlnLAvWS3TQ&s" 
                ...
                <span className="text-lg font-serif font-bold text-brand-blue-50">Ótica Acaz</span>
              </div>
              ...
              <div className="flex gap-3 mt-6">
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 text-brand-yellow-400 flex items-center justify-center border border-white/10 transition-colors" 
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-brand-blue-200">
                <li><a href="#sobre-nos" className="hover:text-brand-yellow-400 transition-colors block">Diferenciais</a></li>
                <li><a href="#produtos-exclusivos" className="hover:text-brand-yellow-400 transition-colors block">Experimentação Presencial</a></li>
                <li><a href="#servicos-premium" className="hover:text-brand-yellow-400 transition-colors block font-serif italic">Nossas Técnicas & Lentes</a></li>
                <li><a href="#cuidados-clinicos" className="hover:text-brand-yellow-400 transition-colors block">Exame Optométrico</a></li>
                <li><a href="#sobre-nos" className="hover:text-brand-yellow-400 transition-colors block">Nossos Diferenciais</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-brand-blue-200">
                ...
                <li className="text-brand-yellow-400 text-xs font-semibold pt-1">
            ...
            <div>
              ...
              <ul className="space-y-3.5 text-xs text-brand-blue-200">
                <li className="flex gap-2">
                  <MapPin className="w-4 h-4 text-brand-yellow-400 shrink-0" />
                  <span>R. Dr. Fláquer, 209 - Centro, São Bernardo do Campo - SP, 09710-180</span>
                </li>
                <li className="flex gap-2">
                  <Phone className="w-4 h-4 text-brand-yellow-400 shrink-0" />
                  <div>
                    <span className="block font-semibold">Telefone &amp; WhatsApp: (11) 4125-7371</span>
                    <span className="block text-[10px] text-brand-blue-300 mt-1 leading-normal italic">(Fixo comercial e celular)</span>
                  </div>
                </li>
                <li className="pt-2">
                  <a
          ...
          <div className="border-t border-brand-blue-800/80 pt-8 mt-8 text-center text-xs text-brand-blue-300 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end" id="flying-chat-box">
        ...
        {showNotification && !isChatOpen && (
          <div className="bg-white text-brand-blue-950 px-4 py-2.5 rounded-xl shadow-xl border border-brand-blue-100 text-left max-w-[250px] mb-3 relative animate-bounce-slow">
            <button
              onClick={(e) => {
                e.stopPropagation();
            ...
            <div className="flex gap-2 items-center">
              ...
              <span className="text-[10px] text-brand-blue-600 font-bold uppercase tracking-wider">Atendimento Acaz</span>
            </div>
        ...
        <AnimatePresence>
          {isChatOpen && (
            <motion.div
              ...
              className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-brand-blue-100 max-w-sm w-[350px] mb-3 text-left"
              id="chat-window"
            >
              ...
              <div className="bg-brand-blue-950 text-white p-4 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="relative">
                    <div className="w-9 h-9 rounded-full bg-white/10 text-white flex items-center justify-center font-bold font-serif text-sm">A</div>
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-brand-blue-300 block leading-none">Online &mdash; Responde na hora</span>
                  </div>
                </div>
              ...
              <div className="p-4 bg-brand-blue-50/50 space-y-3.5 h-[240px] overflow-y-auto font-sans" id="chat-scroller">
                <div className="bg-white p-3 rounded-2xl rounded-tl-none shadow-xs border border-gray-150/50 text-xs text-gray-600 leading-relaxed max-w-[85%]">
              ...
              {/* Chat Quick Actions */}
              <div className="p-3 border-t border-gray-100 flex flex-wrap gap-1.5 justify-start bg-natural-100/50">
                <button
                  onClick={() => setChatMessage("Quero saber mais sobre Lentes Multifocais")}
                  className="text-[10.5px] bg-white border border-gray-250 hover:bg-brand-blue-50 text-brand-blue-950 rounded-lg px-2.5 py-1.5 transition-colors cursor-pointer"
                >
                  Lentes Multifocais
                </button>
                <button
              ...
              >
                <input
                  ...
                  className="bg-neutral-100 flex-1 rounded-xl px-3 py-2 text-xs border border-neutral-200 outline-none text-brand-blue-950 focus:bg-white"
                  id="chat-user-input"
                />
                <button
                  type="submit"
